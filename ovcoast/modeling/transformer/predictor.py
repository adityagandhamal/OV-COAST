# Modified from CAT-Seg: https://github.com/cvlab-kaist/CAT-Seg/blob/main/cat_seg/modeling/transformer/cat_seg_predictor.py
...
from ovcoast.third_party import clip
from ovcoast.third_party import imagenet_templates
